...
public class EmployeeController {
	...
	@GetMapping("/{idnumber}")
	public ResponseEntity<EmployeeResponse> searchEmployee(@PathVariable String idnumber){
		EmployeeResponse employeeResponse = employeeService.searchEmployee(idnumber);
